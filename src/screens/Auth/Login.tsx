      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#f5f7f7] flex-col justify-center items-center px-16">
        <div className="max-w-md text-center">
          ...
          <p className="text-[#454947] mb-8">
            Pick up where you left off on your job search<br />
            journey with Talent Scale.
          </p>
          <img 
      ...
      <div className="w-full lg:w-1/2 flex justify-center items-center">
        <div className="w-full max-w-md px-6 py-12">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <h2 className="text-2xl font-bold text-[#1b3824] mb-1">Log In</h2>
            <p className="text-[#454947]">Welcome back to Talent Scale!</p>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white px-3 text-sm text-[#454947]">Or Log In with Email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-sm font-medium text-[#1b3824]">
                  Password
                </label>
